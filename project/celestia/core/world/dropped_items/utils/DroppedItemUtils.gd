...
func drop_item_in_position(stack: ItemStack, pos: Vector2, dimension: Node2D, set_delay: bool = false) -> void:
	...
	dimension.call_deferred('add_child', drop)
...
func drop_item_entity_foot(stack: ItemStack, entity: LivingEntity) -> void:
	...
	drop_item_in_position(stack, at_pos, entity.get_dimension(), true)
