...
# GODOT
func _init(attacker_param: LivingEntity, primitive_type_param: PRIMITIVE_TYPE, specialized_type_param: SPECIALIZED_TYPE, source_param: SOURCE, tool_param: BaseItem = null, effects_to_apply: Array[EffectInstance] = []) -> void:
